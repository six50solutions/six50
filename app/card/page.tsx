...
import { Download, Mail, Globe, Calendar, Copy, Share2, UserPlus } from 'lucide-react';
...
{/* share info */}
<div data-card-item className="mt-3">
<a
href="/card/connect"
onClick={() => track('share_info_click')}
className={actionBtn + ' w-full'}
>
<UserPlus className="h-4 w-4" /> Share My Info
</a>
</div>
