...
export default function ScopePage() {
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-paper">Scope of Work</h1>
            <div className="bg-ink-800 p-8 rounded-xl shadow-sm border border-line text-paper leading-relaxed space-y-4">
                ...
                <h3 className="text-xl font-bold text-paper mt-6">Deliverables:</h3>
