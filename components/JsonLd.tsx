...
export function OrganizationSchema() {
  const schema = {
    ...
    address: { "@type": "PostalAddress", addressLocality: "Aurora", addressRegion: "IL", addressCountry: "US" },
...
export function LocalBusinessSchema() {
  const schema = {
    ...
    name: "six50 solutions LLC",
    url: "https://six50.io",
    address: { "@type": "PostalAddress", addressLocality: "Aurora", addressRegion: "IL", postalCode: "60505", addressCountry: "US" },
    geo: { "@type": "GeoCoordinates", latitude: 41.7606, longitude: -88.3201 },
