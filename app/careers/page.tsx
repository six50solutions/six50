            ...
            <Section>
                <FadeIn>
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-fog mb-12 max-w-2xl mx-auto">
            ...
            <Section className="bg-ink-800">
                <FadeIn>
                    <div className="max-w-3xl mx-auto text-center">
                        <h2 className="text-2xl font-bold text-paper mb-4">Current Openings</h2>
                        ...
                        <div className="bg-ink-800 p-8 rounded-sm shadow-none border border-line">
                            <h3 className="font-semibold text-paper mb-2">General Application</h3>
