    ...
    <main style={THEME} className="min-h-dvh bg-[var(--dx-bg)] pt-16 pb-[env(safe-area-inset-bottom)] text-[var(--dx-ink)]">
      ...
      <div className="mx-auto max-w-[600px] px-5 py-7 sm:px-6 sm:py-12">
        ...
        <div className="mt-11 sm:flex sm:items-center sm:gap-4">
          ...
          {/* ?new=1 forces a fresh token. A submitted one would fall through
              to minting anyway, but being explicit means this keeps working if
              Start over ever appears somewhere mid-diagnostic. */}
          <a
            href="/scan?new=1"
